...
class SubtitlesViewModelTests {
    ...
    @Test func testTextUpdatesFromService() async throws {
        ...
        // Initial state
        #expect(Self.viewModel.english.isEmpty, "Should start with empty text")
    ...
    @Test func testEmptyTextHandling() async throws {
        ...
        #expect(Self.viewModel.english.isEmpty, "Should handle empty text")

        Self.viewModel.english = "Some text"
        #expect(!Self.viewModel.english.isEmpty, "Should handle non-empty text")

        Self.viewModel.english = ""
        #expect(Self.viewModel.english.isEmpty, "Should handle return to empty text")
    ...
    @Test func testSubtitleStateResetOnStop() async throws {
        ...
        #expect(!Self.viewModel.english.isEmpty, "Should have active subtitle")
        #expect(Self.viewModel.getQueueCountForTesting() > 0, "Should have queued subtitle")
