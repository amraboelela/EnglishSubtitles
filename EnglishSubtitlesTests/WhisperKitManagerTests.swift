...
class WhisperKitManagerTests {
    ...
    @Test func testProcessTranslationAudioPadding() async throws {
        let manager = WhisperKitManager()
        var receivedText: String?
        //var _: Int? // receivedSegment placeholder
        ...
        await manager.processTranslation(
            ...
            receivedText = text
            print("receivedText: \(String(describing: receivedText))")
            _ = segment // Acknowledge segment but don't store
        }
    ...
    @Test func testProcessTranslationSampleRateParameter() async throws {
        ...
        for sampleRate in sampleRates {
            ...
            await manager.processTranslation(
                ...
                callbackCalled = true
                print("callbackCalled: \(callbackCalled)")
            }
        }
    ...
    @Test func testProcessTranslationEmptyAudio() async throws {
        let manager = WhisperKitManager()
        var _: String? // receivedText placeholder
        var _: Int? // receivedSegment placeholder
        ...
        await manager.processTranslation(
            ...
            _ = text // Acknowledge text but don't store
            _ = segment // Acknowledge segment but don't store
        }
